  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-6 py-20">
      <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} className="max-w-lg text-center">
        ...
        <a href={'https://clarity.simplyclear.work/diagnostics/people-impact'} className="inline-flex items-center gap-2 bg-teal text-white text-sm font-medium px-8 py-3.5 rounded-lg hover:bg-teal-dark transition-all">
          Run {tool.title}
